...
public class MainIntroActivity extends IntroActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        addSlide(new SimpleSlide.Builder()
            ...
            .description("Welcome to Gladiator Fitness App! This application is a quick and simple way to record your workout and follow your progression and the evolution of your body.")
